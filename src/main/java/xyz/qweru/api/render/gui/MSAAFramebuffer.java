package xyz.qweru.api.render.gui;
...
public class MSAAFramebuffer extends Framebuffer {
    ...
    public static MSAAFramebuffer getLargestSampleCount() {
        int max = GL30.glGetInteger(GL30C.GL_MAX_SAMPLES);
        if(max > 16) max = 16; // there isn't any point to sample count above 16
